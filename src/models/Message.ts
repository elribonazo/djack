...
export class Message {
    ...
    static fromJson(jsonString: JsonString): Message {
      ...
      if (!messageObj.body || typeof messageObj.body !== "string") {
        throw new Error("undefined or wrong body");
      }
      if (!messageObj.piuri || typeof messageObj.piuri !== "string") {
        throw new Error("undefined or wrong piuri");
      }
      ...
      if (
        ...
        throw new Error("undefined or wrong ack");
      }
      if (
        ...
        throw new Error("undefined or wrong direction");
      }
